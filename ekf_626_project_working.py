# -*- coding: utf-8 -*-
"""ekf_626_project_working

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17owGHBkBaFC4L0yqqLh2nZzWpTsUVzOl
"""
...
def main():
    ...
    # x0_mean = np.zeros((3, 1))
    xEst = np.random.rand(3, 1)*5
    xTrue = np.random.rand(3, 1)*5
    # xEst = np.zeros((3, 1))
    # xTrue = np.zeros((3, 1))

    PEst = np.eye(3)

    xDR = np.random.rand(3, 1)*5  # Dead reckoning
